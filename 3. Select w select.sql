...
SELECT name FROM world WHERE continent = 'Europe' AND GDP/population > (SELECT GDP/population FROM world
...
SELECT name, continent, population FROM world x WHERE continent IN (SELECT continent FROM world y WHERE 25000000 >= ALL (SELECT population FROM world z WHERE y.continent = z.continent));
...
SELECT name, continent FROM world x WHERE population / 3 > ALL(SELECT population FROM world y
